                    ...
                    <div style="background: var(--card-bg); border: 1px solid var(--border-color); border-radius: 12px; padding: 1.25rem; display: flex; align-items: center; gap: 1.25rem;">
                        ...
                        <div style="flex:1; min-width:0;">
                            ...
                            <div style="font-size:0.85rem; font-weight:500;">
                                Harga : Rp <?php echo number_format($item['nominal'], 0, ',', '.'); ?>
                            </div>
                        </div>
                    </div>
                        ...
                        <form action="proses_bukti_pembayaran.php" method="post" enctype="multipart/form-data">

                            <input type="hidden" name="id_reg" value="<?= $item['registration_id'] ?>">
                            <div class="login-input-group">
                                <label for="bukti_<?php echo $item['registration_id']; ?>">
                                <input type="file" name="bukti" id="bukti_<?php echo $item['registration_id']; ?>"
                                                class="input-text" accept="image/*,.pdf">
                            </div>
