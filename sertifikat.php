  ...
  <header>
    ...
    <div class="header-right">
      <div class="user-profile-meta">
        ...
        <span class="user-info-role" style="color: #fff; text-align: right; font-weight: 700;"><?php echo htmlspecialchars($username); ?></span>
      </div>
    ...
    <aside id="sidebar">
      <div class="menu-group">
        ...
        <ul class="menu-items">
          ...
          <li>
            <a href="sertifikat.php" class="menu-link active" style="background-color: #cbeff7; color: #000; border-radius: 12px;">
